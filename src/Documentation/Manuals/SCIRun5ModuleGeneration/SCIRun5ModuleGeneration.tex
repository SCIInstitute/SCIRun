...
Shown here is the example \emph{AlgorithmTemplate.cc} in the \emph{\seqsplit{src/Core/Algorithm/Template/}} folder.
\begin{verbatim}
...
Two files are needed for the algorithm, \emph{SortMatrixAlgo.h} and \emph{SortMatrixAlgo.cc}, which should be located in \emph{\seqsplit{src/Core/Algorithms/Math/}}. 
