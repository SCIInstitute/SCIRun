...
To create a new UI, we need to add three new files: a QT file, and a cc and header file for the UI.  
...
\begin{figure}[H]
\scalebox{0.3}{\includegraphics{SCIRun5ModuleGeneration_Figures/simpleUI.png}}
\caption{Locate ReadField module.}
\label{fig:readfield}
\end{figure}
