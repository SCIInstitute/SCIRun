...
#ifndef CORE_ALGORITHMS_ParticleInCell_PIConGPUReaderAlgoAsynch_H
#define CORE_ALGORITHMS_ParticleInCell_PIConGPUReaderAlgoAsynch_H
...
class SCISHARE PIConGPUReaderAlgoAsynch : public AlgorithmBase
    {
    public:
        PIConGPUReaderAlgoAsynch();
