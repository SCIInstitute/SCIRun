...
#ifndef CORE_ALGORITHMS_ParticleInCell_PIConGPUReaderSimpleAlgo_H
#define CORE_ALGORITHMS_ParticleInCell_PIConGPUReaderSimpleAlgo_H
...
class SCISHARE PIConGPUReaderSimpleAlgo : public AlgorithmBase
    {
    public:
        PIConGPUReaderSimpleAlgo();
